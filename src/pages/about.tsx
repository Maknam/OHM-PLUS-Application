...
export default function About() {
  ...
  const coreValues = [
    { icon: Heart, title: "Customer First", description: "Putting African consumers at the heart of everything we do", color: "from-[#FF4E00] to-[#FF4E00]/70" },
    { icon: Zap, title: "Innovation Driven", description: "Continuously pushing boundaries to deliver smarter solutions", color: "from-[#FF4E00] to-[#FF4E00]/70" },
    { icon: Shield, title: "Safety Focused", description: "Protecting lives and property through intelligent monitoring", color: "from-[#0D9444] to-[#0D9444]/70" },
    { icon: HandshakeIcon, title: "Partnership", description: "Building strong relationships with regulators and customers", color: "from-[#004B9E] to-[#004B9E]/70" }
  ];

  const challenges = [
    { icon: TrendingUp, title: "Rising Energy Costs", description: "Energy costs continue to rise, yet users lack insight into where and how power is wasted. Inefficient usage drains finances and weakens productivity.", color: "text-[#FF4E00]", bgColor: "bg-[#FF4E00]/10" },
    { icon: BarChart3, title: "Lack of Smart Monitoring", description: "Most users rely on outdated systems without real-time control or reporting tools, making energy planning impossible.", color: "text-[#004B9E]", bgColor: "bg-[#004B9E]/10" },
    { icon: Zap, title: "Unstable Supply", description: "Frequent blackouts and voltage fluctuations affect both homes and businesses, leading to operational losses and equipment damage.", color: "text-[#FF4E00]", bgColor: "bg-[#FF4E00]/10" },
    { icon: Shield, title: "Safety and Maintenance Gaps", description: "Many facilities lack preventive maintenance systems, leading to electrical faults, safety risks, and downtime that could have been avoided.", color: "text-[#0D9444]", bgColor: "bg-[#0D9444]/10" }
  ];
  ...
  const valueProps = [
    { icon: TrendingUp, title: "Save Energy, Cut Costs", description: "Save up to 30% annually on bills", color: "from-[#FF4E00] to-[#FF4E00]/70" },
    { icon: Shield, title: "Safety First", description: "Detect overloads and fire risks early", color: "from-[#0D9444] to-[#0D9444]/70" },
    { icon: Building2, title: "All-in-One System", description: "Energy, safety, maintenance in one interface", color: "from-[#004B9E] to-[#004B9E]/70" },
    { icon: Globe, title: "Sustainability at the Core", description: "Transition to cleaner energy", color: "from-[#004B9E] to-[#004B9E]/70" }
  ];
      ...
      <div className="container mx-auto px-4 max-w-6xl relative z-10">
        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl font-display font-bold text-foreground mb-6 leading-tight">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#0D9444] to-[#004B9E]">
              Energy Revolution
            </span>
          </h1>
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            ...
            <Link to="/contact">
              <Button size="lg" className="bg-[#FF4E00] hover:bg-[#E04500] text-white shadow-lg shadow-[#FF4E00]/20 text-lg px-8 h-14">
        ...
        {/* Stats Row - Green for success metrics */}
        <motion.div
        ...
        >
          <div className="bg-muted/40 backdrop-blur-md rounded-2xl p-6 text-center border border-border hover:border-[#004B9E]/30 transition-all group">
            <div className="text-4xl md:text-5xl font-bold text-[#0D9444] mb-2 group-hover:scale-110 transition-transform">2</div>
            <div className="text-sm text-foreground/60">Pilot Countries</div>
          </div>
          <div className="bg-muted/40 backdrop-blur-md rounded-2xl p-6 text-center border border-border hover:border-[#004B9E]/30 transition-all group">
            <div className="text-4xl md:text-5xl font-bold text-[#0D9444] mb-2 group-hover:scale-110 transition-transform">200M+</div>
            <div className="text-sm text-foreground/60">Potential Reach</div>
          </div>
          <div className="bg-muted/40 backdrop-blur-md rounded-2xl p-6 text-center border border-border hover:border-[#004B9E]/30 transition-all group">
            <div className="text-4xl md:text-5xl font-bold text-[#0D9444] mb-2 group-hover:scale-110 transition-transform">30%</div>
            <div className="text-sm text-foreground/60">Avg. Energy Savings</div>
          </div>
          <div className="bg-muted/40 backdrop-blur-md rounded-2xl p-6 text-center border border-border hover:border-[#004B9E]/30 transition-all group">
            <div className="text-4xl md:text-5xl font-bold text-[#0D9444] mb-2 group-hover:scale-110 transition-transform">24/7</div>
        ...
        <div className="mb-24">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-display font-bold text-foreground mb-4">
              The Challenge <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#0D9444] to-[#004B9E]">We're Solving</span>
            </h2>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {challenges.map((challenge, index) => (
              <motion.div
                ...
                className="flex gap-4 p-6 bg-muted/40 backdrop-blur-md rounded-2xl border border-border hover:border-[#004B9E]/30 transition-all group"
              >
        ...
        <div className="mb-24">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-display font-bold text-foreground mb-4">
              Our <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#0D9444] to-[#004B9E]">Solution</span>
            </h2>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {solutions.map((solution, index) => (
              <motion.div
                ...
                animate={{ opacity: 1, y: 0 }}
                transition={{ delay: index * 0.1 }}
                className="bg-gradient-to-br from-[#004B9E]/10 to-transparent rounded-2xl p-6 border border-[#004B9E]/20 hover:border-[#004B9E]/40 transition-all group"
              >
                <div className="w-12 h-12 rounded-full bg-[#004B9E]/20 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform mx-auto md:mx-0">
                  <solution.icon className="w-6 h-6 text-[#0D9444]" />
                </div>
        ...
        >
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-display font-bold text-foreground mb-4">
              Our Value <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#0D9444] to-[#004B9E]">Proposition</span>
            </h2>
            <p className="text-xl text-foreground/70">Efficiency, Safety, and Sustainability — Simplified.</p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {valueProps.map((value, index) => (
              <div key={index} className="bg-muted/40 backdrop-blur-md rounded-xl p-6 text-center border border-border hover:border-[#004B9E]/30 transition-all group">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-24">
          <motion.div
            ...
            className="bg-gradient-to-br from-[#004B9E]/20 to-transparent rounded-2xl p-8 border border-[#004B9E]/30"
          >
            <Eye className="w-12 h-12 text-[#0D9444] mb-4 mx-auto md:mx-0" />
          ...
          <motion.div
            ...
            animate={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.6, delay: 0.4 }}
            className="bg-gradient-to-br from-[#0D9444]/20 to-transparent rounded-2xl p-8 border border-[#0D9444]/30"
          >
            <Target className="w-12 h-12 text-[#0D9444] mb-4 mx-auto md:mx-0" />
        ...
        >
          <h2 className="text-3xl font-display font-bold text-foreground text-center mb-12">
            Our Core <span className="text-[#0D9444]">Values</span>
          </h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        >
          <div className="bg-gradient-to-r from-[#004B9E]/20 via-[#0D9444]/20 to-[#004B9E]/20 rounded-3xl p-1">
            <div className="bg-muted/60 backdrop-blur-md rounded-2xl p-8 md:p-12">
              <h2 className="text-3xl font-display font-bold text-foreground text-center mb-12">
                Our <span className="text-[#0D9444]">Journey</span>
              </h2>
              <div className="grid md:grid-cols-4 gap-6">
                {milestones.map((milestone, index) => (
                  ...
                  >
                    <div className="w-16 h-16 rounded-full bg-gradient-to-br from-[#004B9E]/30 to-[#004B9E]/10 flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform">
                      <milestone.icon className="w-8 h-8 text-[#0D9444]" />
                    </div>
                    <div className="text-2xl font-bold text-[#0D9444] mb-1">{milestone.year}</div>
        ...
        >
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-display font-bold text-foreground mb-4">
              Meet Our <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#0D9444] to-[#004B9E]">Leadership</span>
            </h2>
            ...
            {teamMembers.map((member, index) => (
              ...
              >
                ...
                <div className="p-5 text-center">
                  ...
                  <p className="text-sm text-[#0D9444] mb-3">{member.role}</p>
                  <p className="text-sm text-foreground/60 mb-4">{member.bio}</p>
                  <div className="flex gap-3 justify-center">
                    <a href={`mailto:${member.email}`} className="text-foreground/50 hover:text-[#0D9444] transition-colors">
                      <Mail className="w-4 h-4" />
                    </a>
                    <a href={member.linkedin} className="text-foreground/50 hover:text-[#0D9444] transition-colors">
        ...
        >
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-display font-bold text-foreground mb-4">
              Regulatory <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#0D9444] to-[#004B9E]">Partnerships</span>
            </h2>
            <p className="text-xl text-foreground/70">Working with government bodies to ensure compliance and build trust.</p>
          </div>
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-muted/40 backdrop-blur-md rounded-xl p-8 text-center border border-border hover:border-[#004B9E]/30 transition-all group">
              <div className="w-20 h-20 rounded-full bg-[#004B9E]/20 flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform">
                <Building2 className="w-10 h-10 text-[#0D9444]" />
              </div>
            ...
            <div className="bg-muted/40 backdrop-blur-md rounded-xl p-8 text-center border border-border hover:border-[#004B9E]/30 transition-all group">
              <div className="w-20 h-20 rounded-full bg-[#004B9E]/20 flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform">
                <Award className="w-10 h-10 text-[#0D9444]" />
              </div>
            ...
            <div className="bg-muted/40 backdrop-blur-md rounded-xl p-8 text-center border border-border hover:border-[#004B9E]/30 transition-all group">
              <div className="w-20 h-20 rounded-full bg-[#004B9E]/20 flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform">
                <Users className="w-10 h-10 text-[#0D9444]" />
              </div>
        ...
        {/* Final CTA - 10% Action with Orange */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          <div className="bg-gradient-to-r from-[#004B9E]/20 to-[#0D9444]/20 rounded-2xl p-12 border border-border backdrop-blur-sm">
            <h2 className="text-4xl md:text-5xl font-display font-bold text-foreground mb-4">
