...
export default function SMEsRetail() {
  const features = [
    { icon: Activity, title: "Real-Time Monitoring", desc: "Track energy usage across all your locations instantly", gradient: "from-ohm-blue to-ohm-blue/70" },
    { icon: Clock, title: "Off-Hours Detection", desc: "Identify energy waste when your business is closed", gradient: "from-ohm-orange to-ohm-orange/70" },
    { icon: BarChart3, title: "Usage Analytics", desc: "Detailed reports for accounting and budgeting", gradient: "from-ohm-green to-ohm-green/70" },
    { icon: Shield, title: "Surge Protection", desc: "Protect expensive equipment from voltage spikes", gradient: "from-ohm-orange to-ohm-orange/70" },
    { icon: Smartphone, title: "Remote Management", desc: "Monitor all locations from your phone", gradient: "from-ohm-blue to-ohm-blue/70" },
    { icon: DollarSign, title: "Bill Dispute Tool", desc: "Data-backed evidence against estimated bills", gradient: "from-ohm-green to-ohm-green/70" }
  ];

  const benefits = [
    { icon: TrendingDown, title: "35% Energy Savings", desc: "Average reduction in operational costs", color: "text-ohm-green" },
    { icon: Store, title: "Multi-Location", desc: "Monitor unlimited stores from one dashboard", color: "text-ohm-blue" },
    { icon: Users, title: "Team Access", desc: "Give your team secure access permissions", color: "text-ohm-blue" },
    { icon: Zap, title: "24/7 Support", desc: "Dedicated business support line", color: "text-ohm-green" }
  ];
  ...
  return (
    <div className="pt-32 pb-20 min-h-screen relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute top-20 left-10 w-72 h-72 bg-ohm-green/20 rounded-full blur-[120px] animate-pulse" />
        <div className="absolute bottom-20 right-10 w-96 h-96 bg-ohm-blue/10 rounded-full blur-[140px] animate-pulse delay-1000" />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-ohm-green/5 rounded-full blur-[100px]" />
      ...
      <div className="container mx-auto px-4 max-w-6xl relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-20">
          ...
          >
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-ohm-green/20 border border-ohm-green/30 text-ohm-green text-sm font-medium mb-6 mx-auto md:mx-0 w-fit">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-display font-bold text-white mb-6 leading-tight text-center md:text-left">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-ohm-green to-ohm-green">Solution</span>
            </h1>
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="absolute inset-0 bg-gradient-to-br from-ohm-green/30 to-ohm-green/30 rounded-3xl blur-2xl" />
            <div className="relative bg-gradient-to-br from-ohm-green/20 to-ohm-green/10 rounded-3xl p-6 border border-white/20 backdrop-blur-sm overflow-hidden">
              <img 
              ...
              <div className="absolute bottom-4 left-4 right-4 bg-black/80 backdrop-blur-md rounded-xl p-3 border border-ohm-green/30">
                <div className="grid grid-cols-3 gap-2 text-center">
                  <div>
                    ...
                    <div className="text-base sm:text-lg font-bold text-ohm-green">1.8 kW</div>
                  </div>
                  <div className="border-l border-white/20 pl-2">
                    <div className="text-xs text-gray-400">Store 2 - VI</div>
                    <div className="text-base sm:text-lg font-bold text-ohm-green">2.1 kW</div>
                  </div>
                  <div className="border-l border-white/20 pl-2">
        ...
        <div className="mb-24">
          ...
          >
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-display font-bold text-white mb-4 text-center">
              Business <span className="text-transparent bg-clip-text bg-gradient-to-r from-ohm-green to-ohm-green">Features</span>
            </h2>
        ...
        {/* Benefits Section */}
        <div className="mb-24">
          <div className="bg-gradient-to-r from-ohm-green/20 via-ohm-green/20 to-ohm-green/20 rounded-3xl p-1">
            <div className="bg-black/60 backdrop-blur-md rounded-2xl p-8 md:p-12">
              <h2 className="text-2xl sm:text-3xl font-display font-bold text-white text-center mb-4">
                Why SMEs Choose <span className="text-ohm-green">Omhero</span>
              </h2>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                {benefits.map((benefit, index) => (
                  ...
                  >
                    <div className="w-16 h-16 rounded-full bg-gradient-to-br from-ohm-green/30 to-ohm-green/10 flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform">
        ...
        <div className="mb-24">
          <h2 className="text-2xl sm:text-3xl font-display font-bold text-white text-center mb-12">
            Real Business <span className="text-ohm-green">Results</span>
          </h2>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <div className="flex flex-col sm:flex-row justify-between text-sm mb-1 gap-2 sm:gap-0">
                      ...
                      <span className="text-ohm-green text-center sm:text-right">₦325,000</span>
                    </div>
                    <div className="h-2 bg-gray-700 rounded-full overflow-hidden mt-2">
                      <div className="w-[35%] h-full bg-ohm-green rounded-full" />
                    </div>
                  ...
                  <div className="flex flex-col sm:flex-row justify-between pt-3 border-t border-white/10 gap-2 sm:gap-0">
                    ...
                    <span className="text-xl font-bold text-ohm-green text-center sm:text-right">₦175,000</span>
                  </div>
        ...
        >
          <div className="bg-gradient-to-r from-ohm-green/20 to-ohm-green/20 rounded-2xl p-8 sm:p-12 border border-white/20 backdrop-blur-sm">
