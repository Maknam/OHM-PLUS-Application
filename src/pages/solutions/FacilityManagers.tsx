...
export default function FacilityManagers() {
  const features = [
    { icon: Building2, title: "Multi-Property Dashboard", desc: "Manage all properties from one central view", gradient: "from-primary to-primary/70" },
    { icon: FileText, title: "Automated Billing", desc: "Generate tenant bills based on actual usage", gradient: "from-secondary to-secondary/70" },
    { icon: Calendar, title: "Maintenance Scheduling", desc: "Track and schedule preventive maintenance", gradient: "from-destructive to-destructive/70" },
    { icon: Users, title: "Tenant Portal", desc: "Give tenants visibility into their consumption", gradient: "from-primary to-primary/70" },
    { icon: Bell, title: "Alert Management", desc: "Get notified of issues across your portfolio", gradient: "from-destructive to-destructive/70" },
    { icon: TrendingDown, title: "Benchmarking", desc: "Compare performance across properties", gradient: "from-secondary to-secondary/70" }
  ];

  const benefits = [
    { icon: Clock, title: "50% Less Admin Time", desc: "Automated billing and reporting", value: "50%", color: "text-primary" },
    { icon: DollarSign, title: "25% Lower Costs", desc: "Portfolio-wide energy optimization", value: "25%", color: "text-secondary" },
    { icon: Eye, title: "100% Transparency", desc: "Real-time usage visibility", value: "100%", color: "text-primary" },
    { icon: Settings, title: "40% Faster Response", desc: "Automated maintenance alerts", value: "40%", color: "text-destructive" }
  ];
  ...
  const properties = [
    { name: "Sunset Heights", type: "Residential", units: 48, usage: "42,500 kWh", efficiency: "Good", color: "text-secondary" },
    { name: "Business Plaza", type: "Commercial", units: 32, usage: "128,000 kWh", efficiency: "Excellent", color: "text-secondary" },
    { name: "Riverside Complex", type: "Mixed-Use", units: 64, usage: "95,000 kWh", efficiency: "Needs Review", color: "text-destructive" }
  ];
      ...
      <div className="container mx-auto px-4 max-w-6xl relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-20">
          ...
          >
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-display font-bold text-foreground mb-6 leading-tight text-center md:text-left">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-destructive to-destructive">Managers</span>
            </h1>
              ...
              <div className="absolute bottom-4 left-4 right-4 bg-background/80 backdrop-blur-md rounded-xl p-3 border border-destructive/30">
                <div className="grid grid-cols-3 gap-2 text-center">
                  <div>
                    ...
                    <div className="text-base sm:text-lg font-bold text-destructive">127</div>
                  </div>
                  ...
                  <div className="border-l border-border pl-2">
                    ...
                    <div className="text-base sm:text-lg font-bold text-secondary">₦5.2M</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-gradient-to-r from-destructive/20 via-destructive/20 to-destructive/20 rounded-3xl p-1">
            <div className="bg-muted/60 backdrop-blur-md rounded-2xl p-8 md:p-12">
              <h2 className="text-2xl sm:text-3xl font-display font-bold text-foreground text-center mb-4">
                Portfolio <span className="text-destructive">Overview</span>
              </h2>
        ...
        <div className="mb-24">
          <h2 className="text-2xl sm:text-3xl font-display font-bold text-foreground text-center mb-12">
            Benefits for <span className="text-destructive">Facility Managers</span>
          </h2>
          <div className="grid md:grid-cols-2 gap-6">
            <motion.div
              initial={{ opacity: 0, x: -20 }}
              animate={{ opacity: 1, x: 0 }}
              className="bg-muted/40 backdrop-blur-md rounded-xl p-6 border border-border hover:border-destructive/30 transition-all group text-center md:text-left"
            >
        ...
        <div className="mb-24">
          ...
          >
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-display font-bold text-foreground mb-4 text-center">
              Management <span className="text-transparent bg-clip-text bg-gradient-to-r from-destructive to-destructive">Features</span>
            </h2>
        ...
        <div className="mb-24">
          <div className="bg-muted/40 backdrop-blur-md rounded-2xl p-8 md:p-12 border border-border">
            <h2 className="text-2xl sm:text-3xl font-display font-bold text-foreground text-center mb-12">
              Proven <span className="text-destructive">Results</span>
            </h2>
        ...
        <div className="mb-24">
          <h2 className="text-2xl sm:text-3xl font-display font-bold text-foreground text-center mb-12">
            Portfolio <span className="text-destructive">Success Stories</span>
          </h2>
