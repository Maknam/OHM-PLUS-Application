      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        >
          <Link href={`/news/${featuredArticle.slug}`}>
            <Card className="bg-card/50 border-primary/20 overflow-hidden hover:border-primary/50 transition-colors group cursor-pointer">
              <div className="grid md:grid-cols-2">
                <div className="h-64 md:h-auto bg-sidebar border-b md:border-b-0 md:border-r border-border relative flex items-center justify-center overflow-hidden">
          ...
          {restArticles.map((article, i) => (
            ...
            >
              <Link href={`/news/${article.slug}`}>
                <Card className="h-full bg-card/50 border-primary/10 hover:border-primary/30 transition-all hover:shadow-[0_0_20px_rgba(0,114,206,0.1)] group flex flex-col cursor-pointer">
                  <div className="h-48 bg-sidebar border-b border-border relative flex items-center justify-center overflow-hidden shrink-0">
                    <div className="text-muted-foreground/10 font-display text-2xl font-bold select-none">
                      NEWS
                    </div>
                  </div>
                  <CardContent className="p-6 flex-1 flex flex-col">
                    <div className="flex items-center justify-between mb-4">
                      <Badge variant="outline" className="bg-sidebar border-border text-muted-foreground text-xs">
                        {article.category}
                      </Badge>
