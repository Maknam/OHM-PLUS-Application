...
export default function Tariffs() {
  ...
  const nigeriaTariffs = [
    { category: "Band A (Min 20hrs)", rate: "₦ 206.80", desc: "Premium Areas", savings: "20+ hours daily", color: "text-red-400" },
    { category: "Band B (Min 16hrs)", rate: "₦ 63.30", desc: "Urban Areas", savings: "16-20 hours daily", color: "text-orange-400" },
    { category: "Band C (Min 12hrs)", rate: "₦ 42.44", desc: "Semi-Urban Areas", savings: "12-16 hours daily", color: "text-yellow-400" },
    { category: "Band D (Min 8hrs)", rate: "₦ 29.50", desc: "Rural Areas", savings: "8-12 hours daily", color: "text-green-400" },
    { category: "Band E (Min 4hrs)", rate: "₦ 29.50", desc: "Remote Areas", savings: "4-8 hours daily", color: "text-blue-400" },
  ];

  const comparisonTips = [
    { icon: TrendingUp, text: "Band A customers pay 7x more than Band C - monitor your supply hours carefully", color: "text-red-400" },
    { icon: TrendingDown, text: "Ghana's block tariff means high users pay progressively more - track your consumption", color: "text-green-400" },
    { icon: Zap, text: "Consider solar or inverter systems if you're in higher tariff bands", color: "text-yellow-400" },
    { icon: CheckCircle2, text: "Omhero helps you track exactly which band you qualify for based on your usage", color: "text-primary" },
  ];
  ...
  return (
    <div className="pt-32 pb-24 min-h-screen relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute top-20 left-10 w-72 h-72 bg-teal-500/20 rounded-full blur-[120px] animate-pulse" />
        <div className="absolute bottom-20 right-10 w-96 h-96 bg-green-500/10 rounded-full blur-[140px] animate-pulse delay-1000" />
      ...
      <div className="container mx-auto px-4 max-w-6xl relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-teal-500/20 backdrop-blur-sm border border-teal-500/30 text-teal-500 text-sm font-medium mb-6">
            <FileText className="w-4 h-4" />
            Understanding Your Energy Costs
          </div>
          <h1 className="text-5xl md:text-6xl font-display font-bold text-white mb-6">
            Electricity <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-400 to-green-500">Tariffs</span>
          </h1>
        ...
        <motion.div
          ...
          className="mb-12"
        >
          <div className="bg-gradient-to-r from-teal-500/20 via-green-500/20 to-emerald-500/20 rounded-2xl p-1">
              ...
              <div className="grid md:grid-cols-2 gap-6 items-center">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="border-t border-white/10 pt-2 mt-2">
                      <div className="flex justify-between">
                        ...
                        <span className="text-2xl font-bold text-teal-400">{sampleBill.currency} {sampleBill.total.toLocaleString()}</span>
                      </div>
                    </div>
                  </div>
                </div>
                <div className="bg-teal-500/10 rounded-xl p-4 border border-teal-500/20">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-sm text-teal-400 font-medium">Pro Tip</span>
                  </div>
        ...
        <Tabs defaultValue="ghana" className="w-full" onValueChange={setActiveTab}>
          <div className="flex justify-center mb-8">
            <TabsList className="bg-black/40 backdrop-blur-md border border-white/10 p-1 rounded-xl">
              <TabsTrigger 
                value="ghana" 
                className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-teal-500 data-[state=active]:to-green-500 data-[state=active]:text-white px-8 py-2 rounded-lg transition-all"
              >
              ...
              <TabsTrigger 
                value="nigeria" 
                className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-green-500 data-[state=active]:to-emerald-500 data-[state=active]:text-white px-8 py-2 rounded-lg transition-all"
              >
          ...
          <TabsContent value="ghana">
            ...
            >
              <Card className="bg-black/40 backdrop-blur-md border-teal-500/30 overflow-hidden">
                <div className="h-1 bg-gradient-to-r from-teal-500 to-green-500" />
                <CardContent className="p-0">
                  <Table>
                    <TableHeader className="bg-black/50">
                      <TableRow className="border-white/10 hover:bg-transparent">
                        <TableHead className="text-teal-400 py-4 px-6 font-bold">Customer Category</TableHead>
                        <TableHead className="text-teal-400 py-4 px-6 font-bold">Energy Rate per kWh</TableHead>
                        <TableHead className="text-teal-400 py-4 px-6 font-bold">Monthly Service Charge</TableHead>
                        <TableHead className="text-teal-400 py-4 px-6 font-bold">Best For</TableHead>
                      </TableRow>
                    </TableHeader>
                    <TableBody>
                      {ghanaTariffs.map((tariff, index) => (
                        <TableRow key={tariff.category} className="border-white/10 hover:bg-teal-500/5 transition-colors">
              ...
              <Card className="bg-black/40 backdrop-blur-md border-green-500/30 overflow-hidden">
                ...
                <CardContent className="p-0">
                  <Table>
                    <TableHeader className="bg-black/50">
                      <TableRow className="border-white/10 hover:bg-transparent">
                        <TableHead className="text-green-400 py-4 px-6 font-bold">Service Band</TableHead>
                        <TableHead className="text-green-400 py-4 px-6 font-bold">Description</TableHead>
                        <TableHead className="text-green-400 py-4 px-6 font-bold">Energy Rate per kWh</TableHead>
                        <TableHead className="text-green-400 py-4 px-6 font-bold">Supply Hours</TableHead>
                      </TableRow>
                    </TableHeader>
                    <TableBody>
                      {nigeriaTariffs.map((tariff) => (
                        <TableRow key={tariff.category} className="border-white/10 hover:bg-green-500/5 transition-colors">
        ...
        >
          <div className="bg-yellow-500/10 border border-yellow-500/20 rounded-xl p-5 flex gap-4">
            ...
            <div>
              <p className="text-yellow-500/90 text-sm font-medium mb-1">Important Disclaimer</p>
        ...
        >
          <h2 className="text-2xl font-display font-bold text-white text-center mb-6">
            Tariff <span className="text-primary">Insights</span>
          </h2>
        ...
        <motion.div
          ...
          className="mt-12"
        >
          <div className="bg-gradient-to-r from-primary/20 to-cyan-500/20 rounded-2xl p-1">
            <div className="bg-black/60 backdrop-blur-md rounded-xl p-6">
              <div className="grid md:grid-cols-2 gap-6 items-center">
                <div>
                  <div className="flex items-center gap-2 mb-3">
                ...
                <div className="text-center bg-black/40 rounded-xl p-4 border border-primary/30">
        ...
        >
          <div className="bg-gradient-to-r from-teal-500/20 to-green-500/20 rounded-2xl p-8 border border-white/20 backdrop-blur-sm">
            ...
            <Link to="/services/bill-calculator">
              <Button size="lg" className="bg-gradient-to-r from-teal-500 to-green-500 hover:from-teal-600 hover:to-green-600 text-white shadow-lg shadow-teal-500/20 gap-2">
