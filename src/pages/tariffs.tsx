...
export default function Tariffs() {
  ...
  const nigeriaTariffs = [
    { category: "Band A (Min 20hrs)", rate: "₦ 206.80", desc: "Premium Areas", savings: "20+ hours daily", color: "text-[#FF4E00]" },
    { category: "Band B (Min 16hrs)", rate: "₦ 63.30", desc: "Urban Areas", savings: "16-20 hours daily", color: "text-[#FF4E00]" },
    { category: "Band C (Min 12hrs)", rate: "₦ 42.44", desc: "Semi-Urban Areas", savings: "12-16 hours daily", color: "text-[#0D9444]" },
    { category: "Band D (Min 8hrs)", rate: "₦ 29.50", desc: "Rural Areas", savings: "8-12 hours daily", color: "text-[#004B9E]" },
    { category: "Band E (Min 4hrs)", rate: "₦ 29.50", desc: "Remote Areas", savings: "4-8 hours daily", color: "text-[#004B9E]" },
  ];

  const comparisonTips = [
    { icon: TrendingUp, text: "Band A customers pay 7x more than Band C - monitor your supply hours carefully", color: "text-[#FF4E00]" },
    { icon: TrendingDown, text: "Ghana's block tariff means high users pay progressively more - track your consumption", color: "text-[#0D9444]" },
    { icon: Zap, text: "Consider solar or inverter systems if you're in higher tariff bands", color: "text-[#FF4E00]" },
    { icon: CheckCircle2, text: "Omhero helps you track exactly which band you qualify for based on your usage", color: "text-[#0D9444]" },
  ];
      ...
      <div className="container mx-auto px-4 max-w-6xl relative z-10">
        ...
        >
          ...
          <h1 className="text-5xl md:text-6xl font-display font-bold text-foreground mb-6">
            Electricity <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#0D9444] to-[#004B9E]">Tariffs</span>
          </h1>
              ...
              <div className="grid md:grid-cols-2 gap-6 items-center">
                <div>
                  <div className="flex items-center gap-2 mb-3">
                    <Calculator className="w-5 h-5 text-[#0D9444]" />
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="border-t border-border pt-2 mt-2">
                      <div className="flex justify-between">
                        ...
                        <span className="text-2xl font-bold text-[#0D9444]">{sampleBill.currency} {sampleBill.total.toLocaleString()}</span>
                      </div>
                    </div>
                  </div>
                </div>
                <div className="bg-[#004B9E]/10 rounded-xl p-4 border border-[#004B9E]/20">
                  <div className="flex items-center gap-2 mb-2">
                    <Info className="w-4 h-4 text-[#0D9444]" />
                    <span className="text-sm text-[#0D9444] font-medium">Pro Tip</span>
                  </div>
        ...
        <Tabs defaultValue="ghana" className="w-full" onValueChange={setActiveTab}>
          <div className="flex justify-center mb-8">
            <TabsList className="bg-muted/40 backdrop-blur-md border border-border p-1 rounded-xl">
              <TabsTrigger 
                value="ghana" 
                className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-[#004B9E] data-[state=active]:to-[#004B9E] data-[state=active]:text-white px-8 py-2 rounded-lg transition-all text-foreground/70 data-[state=active]:text-white"
              >
              ...
              <TabsTrigger 
                value="nigeria" 
                className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-[#0D9444] data-[state=active]:to-[#0D9444] data-[state=active]:text-white px-8 py-2 rounded-lg transition-all text-foreground/70 data-[state=active]:text-white"
              >
          ...
          <TabsContent value="ghana">
            ...
            >
              <Card className="bg-muted/40 backdrop-blur-md border-[#004B9E]/30 overflow-hidden">
                <div className="h-1 bg-gradient-to-r from-[#004B9E] to-[#004B9E]" />
                <CardContent className="p-0">
                  <Table>
                    <TableHeader className="bg-muted/60">
                      <TableRow className="border-border hover:bg-transparent">
                        <TableHead className="text-[#0D9444] py-4 px-6 font-bold">Customer Category</TableHead>
                        <TableHead className="text-[#0D9444] py-4 px-6 font-bold">Energy Rate per kWh</TableHead>
                        <TableHead className="text-[#0D9444] py-4 px-6 font-bold">Monthly Service Charge</TableHead>
                        <TableHead className="text-[#0D9444] py-4 px-6 font-bold">Best For</TableHead>
                      </TableRow>
                    </TableHeader>
                    <TableBody>
                      {ghanaTariffs.map((tariff, index) => (
                        <TableRow key={tariff.category} className="border-border hover:bg-[#004B9E]/5 transition-colors">
              ...
              <Card className="bg-muted/40 backdrop-blur-md border-[#0D9444]/30 overflow-hidden">
                ...
                <CardContent className="p-0">
                  <Table>
                    <TableHeader className="bg-muted/60">
                      <TableRow className="border-border hover:bg-transparent">
                        <TableHead className="text-[#0D9444] py-4 px-6 font-bold">Service Band</TableHead>
                        <TableHead className="text-[#0D9444] py-4 px-6 font-bold">Description</TableHead>
                        <TableHead className="text-[#0D9444] py-4 px-6 font-bold">Energy Rate per kWh</TableHead>
                        <TableHead className="text-[#0D9444] py-4 px-6 font-bold">Supply Hours</TableHead>
                      </TableRow>
                    </TableHeader>
                    <TableBody>
                      {nigeriaTariffs.map((tariff) => (
                        <TableRow key={tariff.category} className="border-border hover:bg-[#0D9444]/5 transition-colors">
        ...
        <motion.div
          ...
          className="mt-8"
        >
          <div className="bg-[#FF4E00]/10 border border-[#FF4E00]/20 rounded-xl p-5 flex gap-4">
            <AlertCircle className="w-5 h-5 text-[#FF4E00] shrink-0 mt-0.5" />
            <div>
              <p className="text-[#FF4E00]/90 text-sm font-medium mb-1">Important Disclaimer</p>
        ...
        >
          <h2 className="text-2xl font-display font-bold text-foreground text-center mb-6">
            Tariff <span className="text-[#0D9444]">Insights</span>
          </h2>
          ...
          <div className="bg-gradient-to-r from-[#004B9E]/20 to-[#0D9444]/20 rounded-2xl p-1">
            <div className="bg-muted/60 backdrop-blur-md rounded-xl p-6">
              <div className="grid md:grid-cols-2 gap-6 items-center">
                <div>
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-start gap-2 text-sm text-foreground/70">
                      <CheckCircle2 className="w-4 h-4 text-[#0D9444] shrink-0 mt-0.5" />
                ...
                <div className="text-center bg-muted/40 rounded-xl p-4 border border-[#004B9E]/30">
                  <Zap className="w-8 h-8 text-[#0D9444] mx-auto mb-2" />
                  <p className="text-sm text-foreground/70 mb-3">
                    With Omhero, you'll never be surprised by your tariff category again
                  </p>
                  <Link to="/product">
                    <Button size="sm" className="bg-[#004B9E] hover:bg-[#003A7A] text-white">
        ...
        {/* CTA to Calculator - 10% ACTION HIGHLIGHT: Orange (#FF4E00) */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          <div className="bg-gradient-to-r from-[#004B9E]/20 to-[#0D9444]/20 rounded-2xl p-8 border border-border backdrop-blur-sm">
            ...
            <Link to="/services/bill-calculator">
              <Button size="lg" className="bg-[#FF4E00] hover:bg-[#E04500] text-white shadow-lg shadow-[#FF4E00]/20 gap-2">
